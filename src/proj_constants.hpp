#pragma once
constexpr int DISPLAY_WIDTH = 16;
constexpr int DISPLAY_HEIGHT = 9;
...
constexpr int FULL_SANDIFY_TIME = 15000;

constexpr int NUM_INDEX[4] = {1,5,10,14};
constexpr int FADE_IN_TIME = 4000;
